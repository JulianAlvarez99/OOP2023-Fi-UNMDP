...
bool tateti::marcar_casilla(int casilla,int jugador)
{
...
int tateti::get_estado_casilla(int casilla)const
{
    switch(casilla)
    {
    case 1:
...
int tateti::get_estado_tateti()const
{
    return estado;
}

void tateti::mostrar_tateti()const
{
    cout << endl;
...
char tateti::simbolo_casilla(int casilla)const
{
    switch(casilla)
    {
    case 1:
